...
public class EmployeeOperationsController {
	...
	@GetMapping("/preport")
	public String getEmployeePage(@PageableDefault(page = 0, size = 5,sort = "job",direction = Direction.ASC) Pageable pagable, 
			Map<String,Object> map)
	{
		Page<Employee> pages= empService.getAllEmpbyPages(pagable);
		map.put("Employees", pages);
		return "show_emp_data_pages";
	}
